...
//  CustomIOSAlertView
//
//  Created by zhenyu.wang on 14-8-25.
...
@interface CustomIOSAlertView()<UIGestureRecognizerDelegate>{
...
- (void)show
{
    ...
    dialogView.layer.backgroundColor = [RGB(248, 248, 248) CGColor];
...
- (UIView *)createContainerView
{
    ...
    dialogContainer.layer.borderColor = [RGBACOLOR(239, 239, 239, 1) CGColor];
    ...
    UIImageView *lineImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, dialogContainer.bounds.size.height - buttonHeight - buttonSpacerHeight, dialogContainer.bounds.size.width, 1)];
    lineImageView.image = [UIImage imageNamed:@"lineBottom"];
    [dialogContainer addSubview:lineImageView];
    // ^^^
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        if (self.actionButtonColor) {
            [closeButton setTitleColor:self.actionButtonColor forState:UIControlStateNormal];
            [closeButton setTitleColor:self.actionButtonColor forState:UIControlStateHighlighted];
        }else{
            if (i == [buttonTitles count]-1) {
                [closeButton setTitleColor:ThemeColor forState:UIControlStateNormal];
                [closeButton setTitleColor:ThemeColor forState:UIControlStateHighlighted];
            }else{
                [closeButton setTitleColor:TextGrayColor forState:UIControlStateNormal];
                [closeButton setTitleColor:TextGrayColor forState:UIControlStateHighlighted];
            }
        }
...
//        [closeButton.layer setCornerRadius:kCustomIOSAlertViewCornerRadius];
        ...
        if (i > 0) {
            UIImageView *lineImageView = [[UIImageView alloc] initWithFrame:CGRectMake(i * buttonWidth, closeButton.frame.origin.y, 1, buttonHeight)];
            lineImageView.image = [UIImage imageNamed:@"lineLeft"];
