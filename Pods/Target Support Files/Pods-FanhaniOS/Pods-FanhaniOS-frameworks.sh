...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../../fanhandata_flutter/ios/Flutter/engine/Flutter.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_audio_recorder/flutter_audio_recorder.framework"
  ...
  install_framework "${PODS_ROOT}/../../fanhandata_flutter/ios/Flutter/App.framework"
