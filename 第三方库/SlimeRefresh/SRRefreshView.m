...
//        _alertLabael.textAlignment = NSTextAlignmentCenter;
        ...
        [_alertLabael setTitle:NSLocalizedString(@"alertRefreshSuccess", nil) forState:UIControlStateNormal];
        [_alertLabael setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
