...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    if (self.delegatePageContentView && [self.delegatePageContentView respondsToSelector:@selector(endDeceleratingPageContentView:targetIndex:)]) {
    [self.delegatePageContentView endDeceleratingPageContentView:self targetIndex:self.currentIndex];
}
}
